...
@XmlType(name = "RouteEventResultType", propOrder = { "accolades", "durability", "eventId", "eventSessionId",
		"exitPath", "inviteLifetimeInMilliseconds", "lobbyInviteId", "personaId", "entrants" })
@XmlRootElement(name = "RouteEventResult")
public class RouteEventResultType {
	...
	@XmlElement(name = "RouteEntrantResult", type = RouteEntrantResultType.class)
	@XmlElementWrapper(name = "Entrants")
	private List<RouteEntrantResultType> entrants;
	...
	public List<RouteEntrantResultType> getEntrants() {
		return entrants;
	}

	public void setEntrants(List<RouteEntrantResultType> entrants) {
