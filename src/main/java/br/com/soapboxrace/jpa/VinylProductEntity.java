...
@XmlRootElement(name = "ProductTrans")
public class VinylProductEntity implements ISoapBoxEntity {
	
	private static final long serialVersionUID = -1614309131072246343L;
